...
) { //TODO CHANGE THE TYPE OF THE ORACLE TO THE INTERFACE OF ORACLE WHEN AVAILABLE
}

/// Construct an ADL order, a decrease order is used to reduce a profitable position.
/// # Arguments
/// * `CreateAdlOrderParams` - The struct.
/// # Returns
...
/// * `market` - Address of the market to check.
/// * `is_long` - Indicates whether to check the long or short side of the market.
/// * `value` - The value tolatest block value.
/// # Returns
/// Return the latest block value.
fn set_latest_adl_block(
    data_store: IDataStoreSafeDispatcher, market: ContractAddress, is_long: bool, value: u128
) -> u128 {
    //TODO
    0
}
