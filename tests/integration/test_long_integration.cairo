...
fn test_long_increase_decrease_close() {
    ...
    exchange_router
        .send_tokens(market.long_token, deposit_vault.contract_address, 50000000000000000000000000000);
    exchange_router
        .send_tokens(market.short_token, deposit_vault.contract_address, 50000000000000000000000000000);
    ...
    assert(first_position_close.size_in_tokens == 0, 'Size token should be 62574.99');
    assert(first_position_close.size_in_usd == 0, 'Size should be 62574.99');
    assert(first_position_close.borrowing_factor == 0, 'Borrow should be 62574.99');
    assert(first_position_close.collateral_amount == 0, 'Collat should be 62574.99');
...
//     let market_prices_liquidation = market_utils::MarketPrices {
//         index_token_price: Price { min: 2500, max: 2500, },
//         long_token_price: Price { min: 2500, max: 2500, },
//         short_token_price: Price { min: 1, max: 1, },
//     };
...
//     oracle.set_primary_prices(market.long_token, 2500);
...
//     let keeper_address = contract_address_const::<'keeper'>();
//     role_store.grant_role(keeper_address, role::ORDER_KEEPER);
//     role_store.grant_role(keeper_address, role::LIQUIDATION_KEEPER);
...
// #[test]
// #[should_panic(expected: ('position not be liquidated',))]
// fn test_long_liquidable_fails_integration() {
//     // *********************************************************************************************
//     // *                              SETUP                                                        *
//     // *********************************************************************************************
//     let (
